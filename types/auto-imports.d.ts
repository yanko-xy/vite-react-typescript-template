...
declare global {
  ...
  const AntdButton: typeof import('antd')['Button']
  const AseTest: typeof import('../src/hooks/demo/demo')['AseTest']
  const Button: typeof import('antd')['Button']
  const Header: typeof import('../src/components/Header/index')['default']
  const Headersa: typeof import('../src/components/Header/index')['Headersa']
